/*
This code has been modified to fit the CC3200 Launchpad from Arduino
*/
...
GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00); // low for command pin 62

MAP_SPICSEnable(GSPI_BASE);
GPIOPinWrite(GPIOA1_BASE, 0x1, 0x00);

MAP_SPIDataPut(GSPI_BASE,c);
MAP_SPIDataGet(GSPI_BASE,&dumb);

MAP_SPICSDisable(GSPI_BASE);
GPIOPinWrite(GPIOA1_BASE, 0x1, 0xFF);
...
GPIOPinWrite(GPIOA0_BASE, 0x80, 0xFF); // high for data pin 62
